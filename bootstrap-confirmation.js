...
+function ($) {
    ...
    Confirmation.prototype.setContent = function () {
        ...
        options.onConfirm = this.getConfirm();
        options.onConfirm = (typeof options.onConfirm == 'function') ? options.onConfirm : new Function(options.onConfirm);
        options.onCancel = this.getCancel();
        options.onCancel = (typeof options.onCancel == 'function') ? options.onCancel : new Function(options.onCancel);
        ...
        $btnOk.addClass(this.getBtnOkClass())
            ...
            .off('click').on('click', function(event) {
                ...
                (typeof options.onConfirm == 'function') ?
                    options.onConfirm(event, that.$element) : new Function(options.onConfirm(event, that.$element));
    ...
    Confirmation.prototype.getConfirm = function () {
        var $e = this.$element;
        var o  = this.options;
        return $e.attr('data-onConfirm') || (typeof o.target == 'function' ? o.target.call(this, $e[0]) : o.target);
    }

    Confirmation.prototype.getCancel = function () {
        var $e = this.$element;
        var o  = this.options;

        return $e.attr('data-onCancel') || (typeof o.target == 'function' ? o.target.call(this, $e[0]) : o.target);
    }
